...
Authenticated pages use Recording Studio's default layout and Flatpack. Dummy `config/importmap.rb` pins Turbo and Recording Studio Admin screen controllers so product tables load.
